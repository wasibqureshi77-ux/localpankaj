...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`sticky top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${isScrolled ? "bg-white/95 backdrop-blur-md border-gray-100 shadow-sm py-3" : "bg-white border-transparent py-5"
          }`}
      >
