...
const FormLabel = ({ children, required, meta }: any) => (
  <div className="flex justify-between items-center mb-1.5">
    ...
    {meta && <span className="text-[10px] font-medium text-gray-400 tracking-wider">{meta}</span>}
  </div>
);
    ...
    return (
      <div className="max-w-3xl mx-auto px-6 py-20 animate-in fade-in duration-500 print:py-0 print:max-w-none print:px-0">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-sm font-medium text-gray-500 tracking-widest">Assignment ID: <span className="text-gray-900">#{confirmedOrder.orderId}</span></p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-8">
            <section>
              <h4 className="text-[10px] font-bold text-gray-400 tracking-widest mb-4 border-b pb-2">Deployment Logistics</h4>
              <div className="space-y-3">
                ...
                <div className="py-2.5">
                  <p className="text-[10px] font-bold text-gray-400 tracking-widest mb-1.5">Client Address </p>
                  <p className="text-sm font-medium text-gray-800 leading-loose">{confirmedOrder.address}, {confirmedOrder.pincode}</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-8">
            <section>
                <h4 className="text-[10px] font-bold text-gray-400 tracking-widest mb-4 border-b pb-2">Financial Summary</h4>
      ...
      <div className="mt-16 flex flex-wrap items-center justify-center gap-4">
           <Link href="/dashboard" className="h-10 px-6 bg-gray-900 text-white rounded-[6px] text-xs font-bold tracking-widest flex items-center hover:bg-black transition-colors">
              Manage Orders
           </Link>
           <button onClick={() => window.print()} className="h-10 px-6 border border-gray-200 text-gray-600 rounded-[6px] text-xs font-bold tracking-widest flex items-center gap-2 hover:bg-gray-50">
              <Download size={14} /> Download Receipt
           </button>
           <Link href="/" className="h-10 px-6 border border-gray-200 text-gray-600 rounded-[6px] text-xs font-bold tracking-widest flex items-center hover:bg-gray-50">
              Back to Home
           </Link>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className={currentStep === 1 ? 'opacity-100' : 'opacity-40 pointer-events-none grayscale'}>
              ...
              {currentStep === 1 && (
                <button onClick={validateStep1} className="h-11 px-8 bg-blue-600 text-white rounded-[6px] text-xs font-bold tracking-widest hover:bg-blue-700 transition-colors shadow-sm">
            ...
            <div className={currentStep === 2 ? 'opacity-100' : 'opacity-40 pointer-events-none'}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                       {["09-11 AM", "11-01 PM", "01-03 PM", "03-05 PM", "05-07 PM", "07-09 PM"].map(slot => (
                         <button 
                           ...
                           className={`h-10 px-1 border rounded-[6px] text-[10px] font-bold tracking-widest transition-all ${form.time === slot ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-gray-200 text-gray-500 hover:border-gray-400'}`}
                         >
                           {slot}
                         </button>
                       ))}
               ...
               {currentStep === 2 && (
                 <div className="mt-10 flex gap-3">
                    <button onClick={() => setCurrentStep(1)} className="h-11 px-6 border border-gray-200 text-gray-600 rounded-[6px] text-xs font-bold tracking-widest">
                       Back
                    </button>
                    <button onClick={validateStep2} className="h-11 px-8 bg-blue-600 text-white rounded-[6px] text-xs font-bold tracking-widest shadow-sm">
                       Review Payment
                    </button>
                 </div>
               )}
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-medium tracking-wider mt-1.5">UPI, Cards, Net Banking</p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-medium tracking-wider mt-1.5">Settle with technician post-duty</p>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-5 relative">
             <aside className="sticky top-28 bg-white border border-gray-100 rounded-[8px] p-8 shadow-sm">
                <h4 className="text-[11px] font-bold text-gray-400 tracking-widest border-b pb-3 mb-6">Service Docket History</h4>
                ...
                <div className="space-y-1 mb-8">
                  ...
                  <div className="pt-5 mt-4 border-t flex justify-between items-end">
                    <div>
                      <span className="text-[10px] font-bold text-gray-400 tracking-widest block mb-1">Total Obligation</span>
                      <span className="text-2xl font-bold text-gray-900">₹{grandTotal}</span>
                    </div>
                    <div className="text-right">
                       <span className="text-[9px] font-bold text-emerald-600 tracking-widest bg-emerald-50 px-2 py-0.5 rounded leading-none">Verified Request</span>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full h-12 bg-blue-600 text-white rounded-[6px] text-xs font-bold tracking-widest flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-sm disabled:opacity-50"
                >
