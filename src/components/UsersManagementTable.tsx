    ...
    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div>
          ...
          <p className="text-gray-500 font-bold uppercase tracking-[0.4em] text-[10px] mt-4">{subtitle}</p>
        </div>
            ...
            <table className="w-full text-left">
               ...
               <tbody className="divide-y divide-white/5">
                  {loading ? (
                    ...
                    <tr><td colSpan={6} className="p-20 text-center text-gray-500 font-bold text-xs uppercase tracking-widest">No matching records found.</td></tr>
                  )}
               </tbody>
            </table>
         </div>
