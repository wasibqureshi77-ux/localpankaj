  ...
  return (
    <div className="max-w-6xl mx-auto space-y-16 animate-in fade-in slide-in-from-right-10 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div>
          <h1 className="text-6xl font-black text-indigo-950 tracking-tighter italic">Jaipur <span className="text-indigo-600">Assets.</span></h1>
          <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px] mt-4">Manage your branding and media library.</p>
        </div>
        
        <div className="flex items-center space-x-6">
           <label className="px-10 py-5 bg-indigo-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest transition shadow-2xl shadow-indigo-600/30 transform hover:-translate-y-1 active:scale-95 cursor-pointer flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-4">
               <div className="relative group">
                  ...
                  <input 
                    ...
                    className="pl-12 pr-6 py-4 rounded-xl bg-indigo-50/50 border border-transparent focus:bg-white focus:border-indigo-100 outline-none transition-all font-bold text-xs w-64 uppercase tracking-widest"
                  />
               </div>
      ...
      <div className="bg-indigo-950 text-white p-12 rounded-[3.5rem] flex flex-col md:flex-row items-center justify-between gap-10 overflow-hidden relative group">
         ...
         <div className="space-y-4">
            <h3 className="text-3xl font-black italic tracking-tighter">Powered by Cloudinary.</h3>
            <p className="text-indigo-300 font-bold max-w-sm text-[10px] uppercase tracking-widest leading-relaxed opacity-80">
               All your assets are automatically optimized and served via lightning-fast CDN.
            </p>
         </div>
         <button className="px-10 py-5 bg-white text-indigo-950 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all shadow-xl active:scale-95">
            Cloud Settings
         </button>
      </div>
    </div>
         ...
         <div className="aspect-square bg-indigo-50 rounded-[2rem] overflow-hidden relative border border-indigo-50 group-hover:border-indigo-600 transition-all">
            ...
            <div className="absolute inset-0 bg-indigo-950/80 p-6 flex flex-col justify-between opacity-0 group-hover:opacity-100 transition-opacity">
               ...
               <div className="space-y-1">
                  <div className="text-[10px] font-black text-white uppercase tracking-widest truncate">{name}</div>
                  <div className="text-[8px] font-bold text-indigo-400 uppercase tracking-widest">{size} • {type}</div>
               </div>
            </div>
         </div>
      </div>
   ...
   return (
      <div className="flex items-center justify-between p-6 hover:bg-indigo-50 rounded-2xl transition group">
         <div className="flex items-center space-x-6">
            ...
            <div>
               <div className="text-xs font-black text-indigo-950 uppercase tracking-widest">{name}</div>
               <div className="text-[8px] font-bold text-indigo-400 uppercase tracking-widest mt-1">{type} • {size}</div>
            </div>
         </div>
         <div className="flex items-center space-x-12">
            <div className="text-[9px] font-bold text-gray-400 uppercase tracking-widest hidden md:block">{date}</div>
