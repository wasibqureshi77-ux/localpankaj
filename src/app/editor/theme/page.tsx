  ...
  return (
    <div className="max-w-6xl mx-auto space-y-16 animate-in fade-in slide-in-from-right-10 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div>
          <h1 className="text-6xl font-black text-indigo-950 tracking-tighter italic">Jaipur <span className="text-indigo-600">Visuals.</span></h1>
          <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px] mt-4">Fine-tune your brand aesthetics.</p>
        </div>
         ...
         <div className="lg:col-span-2 space-y-12">
            <div className="bg-white p-12 rounded-[3.5rem] border border-indigo-50 shadow-sm space-y-10">
               ...
               <div className="pt-10 border-t border-indigo-50">
                  <label className="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-8">Preset Harmony Boards</label>
            ...
            <div className="bg-white p-12 rounded-[3.5rem] border border-indigo-50 shadow-sm space-y-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-6">
                     <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest">Border Curvature</label>
                  ...
                  <div className="space-y-6">
                     <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest">Interface Contrast</label>
                     <div className="flex items-center space-x-4">
            ...
            <div className="sticky top-40 space-y-8">
               <div className="p-8 bg-gray-950 rounded-[3rem] shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative space-y-6">
                     <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Real-time Preview</h4>
                     ...
                     <div className={`p-6 bg-white shadow-xl transition-all duration-500`} style={{ borderRadius: config.borderRadius }}>
                        ...
                        <button className="mt-6 w-full py-3 text-white font-black text-[8px] uppercase tracking-widest transition-colors" style={{ backgroundColor: config.themeColor, borderRadius: config.borderRadius }}>
                           Button Action
                        </button>
                     </div>
                     ...
                     <div className="pt-6 border-t border-white/5 space-y-4">
                        <div className="flex items-center justify-between">
                           <span className="text-[9px] font-bold text-gray-500 uppercase">Accessibility</span>
                           <span className="text-green-500 font-bold text-[9px]">PASSED</span>
                        </div>
                        <div className="flex items-center justify-between">
                           <span className="text-[9px] font-bold text-gray-500 uppercase">Color Contrast</span>
   ...
   return (
      <div className="space-y-6">
         ...
         <div className="flex items-center space-x-5 p-4 bg-indigo-50/50 rounded-2xl border border-indigo-50 group hover:border-indigo-600 transition-all">
            ...
            <input 
               type="text" 
               className="bg-transparent text-sm font-black text-indigo-900 outline-none w-full uppercase"
               value={value}
               onChange={(e) => onChange(e.target.value)}
            />
         </div>
...
function PresetBoard({ colors, name, onSelect }: any) {
   return (
      ...
      >
         ...
         <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest group-hover:text-indigo-600 transition-colors">{name}</p>
      </button>
   );
}
