...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-neutral-900 pt-32 pb-24 px-4 text-center">
         <div className="container mx-auto max-w-4xl">
            <h1 className="text-6xl font-black text-white italic uppercase tracking-tighter mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700">About Local Pankaj.</h1>
            <p className="text-gray-400 font-bold uppercase tracking-[0.4em] text-xs">Defining Excellence in Jaipur's Service Sector</p>
         </div>
      </section>
         ...
         <div className="container mx-auto max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
               <div className="space-y-8 animate-in fade-in slide-in-from-left-10 duration-700">
                  <h2 className="text-4xl font-black text-gray-950 uppercase italic tracking-tighter">Jaipur's Dedicated Service Force.</h2>
                  ...
                  <div className="grid grid-cols-2 gap-8 pt-8 border-t border-gray-100">
                     <div className="space-y-4">
                        ...
                        <div className="text-2xl font-black italic uppercase tracking-tight text-gray-950">10+ Years</div>
                     </div>
                     <div className="space-y-4">
                        <Users className="text-blue-600" size={32} />
                        <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Technicians</div>
                        <div className="text-2xl font-black italic uppercase tracking-tight text-gray-950">50+ Certified</div>
                     </div>
                  </div>
               </div>
